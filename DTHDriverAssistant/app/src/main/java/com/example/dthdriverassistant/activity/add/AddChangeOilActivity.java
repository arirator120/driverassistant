...
//                Log.d("CheckEqual", lstVehicle.get(i).getName() + "");
    ...
    public void setData(oil o){
        ...
        if(flag == false){
            ...
            o.setId(id);
            dbReference.child(o.getId()).setValue(o); //tạo value cho nhánh trên fb
            Toast.makeText(AddChangeOilActivity.this,"Thêm dữ liệu hoàn tất!!",Toast.LENGTH_SHORT).show();
        }
        else{
            //edit
            dbReference.child(o.getId()).setValue(o); //thay đổi giá trị theo getdata thông qua biến ins
            Intent i = new Intent(AddChangeOilActivity.this, HistoryChangeOilFragment.class);

            startService(i);
            //finish();
            Toast.makeText(AddChangeOilActivity.this,"Cập nhật hoàn tất!!",Toast.LENGTH_SHORT).show();
        }
